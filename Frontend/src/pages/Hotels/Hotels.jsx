...
const Hotels = () => {
  ...
  return (
    <div className="min-h-screen  flex flex-col">
      <div className="">
        {/* Header section */}
        <div className="bg-[#1A4D8C] text-white px-4 py-28">
        ...
        {/* Hotels count */}
        <div className="my-8 max-w-7xl mx-auto px-2">
          <h2 className="text-2xl font-bold text-hotel-dark pl-4 mb-2">
          ...
          {featuredHotels.length > 0 ? (
            ...
            <div className="text-center text-sky-500 font-bold my-8">
              No Hotels Found
            </div>
          )}
        </div>
